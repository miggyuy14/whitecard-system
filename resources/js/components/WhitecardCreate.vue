        ...
        <b-modal id="my-modal">
            ...
            <div class="card card-body">
                <H2>New Whitecard</H2>
                    ...
                    <input type="text" v-model="whitecard.first_name">
                    <label for="last_name">Last Name</label>
                    <input type="text" v-model="whitecard.last_name">
                    <label for="middle_initial">Middle Initial</label>
                    <input type="text" v-model="whitecard.middle_initial">
                    <label for="subject_name">Subject Code</label>
                    <input type="text" v-model="whitecard.subject_name">
                    <label for="middle_initial">Semester</label>
                    <input type="text" v-model="whitecard.semester">
                    <label for="middle_initial">College Branch</label>
                    <input type="text" v-model="whitecard.college_branch">
